ROSManager.controller('settings',['$scope','$http','$location','$routeParams','$timeout','$interval','auth','$rootScope','$q',function($scope,$http,$location,$routeParams,$timeout,$interval,auth,$rootScope,$q){
    /*Inicializálása*/
    $scope.init = function () {
